...
Defined in: [packages/typescript/ai/src/activities/chat/tools/tool-definition.ts:73](https://github.com/TanStack/ai/blob/main/packages/typescript/ai/src/activities/chat/tools/tool-definition.ts#L73)
